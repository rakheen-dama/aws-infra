...
# -----------------------------------------------------------------------------
# Route 53 alias record for apex domain -> ALB
...
# APEX record, not the app subdomain. The app subdomain is created by
# aws_route53_record.subdomains["app"]. Renaming this resource would require
# a `moved` block and state migration, so we keep the name.
# -----------------------------------------------------------------------------
...
# so a single wildcard cert covers both environments.
# -----------------------------------------------------------------------------
